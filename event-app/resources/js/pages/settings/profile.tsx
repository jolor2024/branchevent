            ...
            <h1 className='text-[48px] font-thin py-4 lg:py-0'>REDIGERA KONTO</h1>
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Link
                        href={route('logout')}
                        method="post"
                        className="text-white bg-primary-red hover:bg-[#000] cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive h-9 px-4 py-2 has-[>svg]:px-3"
                    >
                        LOGGA UT
                    </Link>
                        <Button disabled={processing} className='bg-primary-red cursor-pointer'>SPARA</Button>
